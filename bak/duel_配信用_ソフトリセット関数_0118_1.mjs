...
const YT_POLL_INTERVAL_MS = 30_000; // 30秒
...
// ★ 読み上げ待ち時間（超重要）
// =================================================
const BASE_WAIT = 1000;    // ★ 発話開始前の準備待ち（ms）
const PER_CHAR = 170;     // ★ 1文字あたりの読み上げ時間（ms）
const MAX_WAIT = 25000;   // ★ 長文でも待ちすぎない上限
...
async function run() {
  ...
  // 例：duel開始時
  startYouTubeLiveChatPolling("myHVxpjahb4").catch(console.error);
